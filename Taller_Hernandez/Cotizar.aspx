...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div id="info-correo">
                <div class="container">
      <div id="loginbox" style="margin-top: 50px; top: 0px; left: 0px; width: 548px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 ">
    ...
    <td style="width: 641px"><asp:TextBox ID="txtDestinatario" runat="server" placeholder="Destinatario" CssClass="form-control" TextMode="Email"></asp:TextBox></td>
           </tr>
   <tr> 
         <td style="width: 34px"><asp:Label ID="Label2" runat="server" Text="Motivo:"></asp:Label>   </td>
    <td style="width: 641px"><asp:TextBox ID="txtAsunto" runat="server" placeholder="Asunto"  CssClass="form-control"></asp:TextBox></td>
        </tr>
    <tr> 
        <td style="width: 34px"> <asp:Label ID="Label3" runat="server" Text="Cotización:"></asp:Label>   </td>
    <td style="width: 641px"><asp:TextBox ID="txtCuerpo" runat="server" placeholder="Cuerpo" TextMode="MultiLine"  CssClass="form-control" ></asp:TextBox></td>
 </tr>
 <tr> 
